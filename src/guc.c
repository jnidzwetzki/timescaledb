...
TSDLLEXPORT bool ts_guc_enable_decompression_heap_merge = true;
...
_guc_init(void)
{
	...
	DefineCustomBoolVariable("timescaledb.enable_decompression_heap_merge",
							 "Enable compressed batches heap merge",
							 "Enable the merge of compressed batches to preserve the compression "
							 "order by",
							 &ts_guc_enable_decompression_heap_merge,
							 true,
							 PGC_USERSET,
							 0,
							 NULL,
